FIRS e-Invoice Integration Module (v1.0.5)
==========================================

This module integrates Odoo 18 with Nigeria's FIRS e-Invoicing (TaxPro Max) system.

Features:
- Automatically posts customer invoices to FIRS API.
- Retrieves and embeds IRN + QR code on invoice PDF.
...
Installation:
1. Upload `odoo_firs_einvoice_v1.0.5.zip` to your Odoo `addons` folder or Apps interface.
...
6. Validate an invoice to auto-send to FIRS and display QR.
